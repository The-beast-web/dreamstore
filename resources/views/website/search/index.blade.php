    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('website.category.index') }}">Product Category</a></li>
                ...
                <div class="row">
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/products/product-1.jpg') }}" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="{{ route('website.product.main') }}">Nunc dignissim risus</a></h3><!-- End .product-title -->
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                        <div class="product">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/products/product-2.jpg') }}" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/products/product-3.jpg') }}" alt="Product image" class="product-image">
                                </a>
