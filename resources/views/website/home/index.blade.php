...
<main class="main">
    ...
    <div class="container new-arrivals">
        ...
        <div class="tab-content tab-content-carousel just-action-icons-sm">
            ...
            <div class="tab-pane p-0 fade" id="new-acc-tab" role="tabpanel"
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 deal-col">
                <div class="deal"
                    style="background-image: url('assets/images/demos/demo-4/deal/bg-1.jpg');">
                    <div class="deal-top">
            ...
            <div class="col-lg-6 deal-col">
                <div class="deal"
                    style="background-image: url('assets/images/demos/demo-4/deal/bg-2.jpg');">
                    <div class="deal-top">
    ...
    <div class="container for-you">
        <div class="heading heading-flex mb-3">
            ...
            <div class="heading-right">
                <a href="#" class="title-link">View All Recommendation <i
                        class="icon-long-arrow-right"></i></a>
            </div><!-- End .heading-right -->
        </div><!-- End .heading -->
